...
waydroidClipboard = QtWidgets.QAction("开启Waydroid的剪切板同步功能(未做完)")
...
waydroidMenu.addAction(waydroidClipboard)
configMenu.addSeparator()
...
waydroidClipboard.triggered.connect(lambda: threading.Thread(target=RunBash, args=[f"echo '请在下方输入您的sudo密码' && sudo clear && sudo python3 '{programPath}/Runner_tools/SystemConfigs/Clipboard-enable.py'"]).start()) #剪切板添加(试验性功能!)
