...
waydroidGetAndroidId.triggered.connect(lambda: threading.Thread(target=RunBash, args=[f"sudo python3 '{programPath}/Runner_tools/Android-id-reader/android-id.py'"]).start())
# 容器配置栏
