...
waydroidChangeGPU.triggered.connect(lambda: threading.Thread(target=RunBash, args=[f"sudo bash '{programPath}/Runner_tools/SystemConfigs/waydroid-choose-gpu.sh'"]).start())
# 容器配置栏
