...
magiskInstall = QtWidgets.QAction("安装或更新 Magisk")
libhoudiniInstall = QtWidgets.QAction("安装或更新 Libhoudini 翻译器")
widevineInstall = QtWidgets.QAction("安装或更新 Widevine")
waydroidLaguage = QtWidgets.QAction("设置 Waydroid 容器语言为中文")
waydroidClipboard = QtWidgets.QAction("开启 Waydroid 剪切板互通功能")
