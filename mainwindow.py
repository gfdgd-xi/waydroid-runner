...
waydroidClipboard.triggered.connect(lambda: threading.Thread(target=RunBash, args=[f"echo '请在下方输入您的sudo密码' && sudo clear && sudo python3 '{programPath}/Runner_tools/SystemConfigs/Clipboard-enable.py'"]).start())
