...
import time
import subprocess
programPath = os.path.split(os.path.realpath(__file__))[0]  # 获取程序当前路径
...
else:print('- 已跳过特供版Magisk的安装,如果您以后需要可以在Waydroid运行器里安装')
...
# 国内源的 Waydroid 已默认设置中文语言,由于国内源暂时不可用,故在这里设置
